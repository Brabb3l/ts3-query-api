...
ts_response! {
    ServerInfo {
        ...
        download_quota("virtualserver_download_quota"): u64,
        upload_quota("virtualserver_upload_quota"): u64,

        max_download_total_bandwidth("virtualserver_max_download_total_bandwidth"): u64,
        max_upload_total_bandwidth("virtualserver_max_upload_total_bandwidth"): u64,

        month_bytes_downloaded("virtualserver_month_bytes_downloaded"): u64,
        month_bytes_uploaded("virtualserver_month_bytes_uploaded"): u64,
        total_bytes_downloaded("virtualserver_total_bytes_downloaded"): u64,
        total_bytes_uploaded("virtualserver_total_bytes_uploaded"): u64,
        ...
        file_transfer_bandwidth_sent("connection_filetransfer_bandwidth_sent"): u64 = 0,
        file_transfer_bandwidth_received("connection_filetransfer_bandwidth_received"): u64 = 0,
        file_transfer_bytes_sent_total("connection_filetransfer_bytes_sent_total"): u64 = 0,
        file_transfer_bytes_received_total("connection_filetransfer_bytes_received_total"): u64 = 0,

        packets_sent_speech("connection_packets_sent_speech"): u64,
        packets_received_speech("connection_packets_received_speech"): u64,
        packets_sent_keepalive("connection_packets_sent_keepalive"): u64,
        packets_received_keepalive("connection_packets_received_keepalive"): u64,
        packets_sent_control("connection_packets_sent_control"): u64,
        packets_received_control("connection_packets_received_control"): u64,
        packets_sent_total("connection_packets_sent_total"): u64,
        packets_received_total("connection_packets_received_total"): u64,

        bytes_sent_speech("connection_bytes_sent_speech"): u64,
        bytes_received_speech("connection_bytes_received_speech"): u64,
        bytes_sent_keepalive("connection_bytes_sent_keepalive"): u64,
        bytes_received_keepalive("connection_bytes_received_keepalive"): u64,
        bytes_sent_control("connection_bytes_sent_control"): u64,
        bytes_received_control("connection_bytes_received_control"): u64,
        bytes_sent_total("connection_bytes_sent_total"): u64,
        bytes_received_total("connection_bytes_received_total"): u64,

        bandwidth_sent_last_second_total("connection_bandwidth_sent_last_second_total"): u64,
        bandwidth_sent_last_minute_total("connection_bandwidth_sent_last_minute_total"): u64,

        bandwidth_received_last_second_total("connection_bandwidth_received_last_second_total"): u64,
        bandwidth_received_last_minute_total("connection_bandwidth_received_last_minute_total"): u64,
    }
}
